...
// separate their serial numbers with a comma (e.g. "0101010101, 0202020202").
...
// the values for the templates parameter must be separated by a comma (e.g. "user_template, object_template").
...
// and each serial must be separated by a comma (e.g. "010101010101, 020202020202"). If you are assigning
